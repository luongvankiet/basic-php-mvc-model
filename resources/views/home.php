                ...
                <div class="col-12 col-lg-3 py-3">
                    <div class="card shadow-lg">
                        <div class="card-body py-5">
                            <img src="<?php echo \App\Core\Application::assets($trainer->imagePath) ?>" class="img-fluid rounded-circle mx-auto team-image" alt="...">
                            <h3 class="pt-3"><?php echo $trainer->name() ?></h3>
                            <p>Trainer</p>
                            <button type="button" class="btn btn-dark">See Profile</button>
                        </div>
                    </div>
                </div>
            <?php } ?>
