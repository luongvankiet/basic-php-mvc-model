    ...
    <table class="table table-striped table-sm">
        ...
        <tbody>
            <?php foreach ($courses as $key => $course) { ?>
                <tr>
                    <td>
                        <img src="<?php echo \App\Core\Application::assets($course->imagePath) ?>" class="img-thumbnail img-fluid" alt="...">
                    </td>
                    <td class="text-center">#<?php echo $course->id ?></td>
                    <td><?php echo $course->name ?></td>
                    <td><?php echo $course->duration ?></td>
                    <td><?php echo $course->category() ? $course->category()->name : '' ?></td>
                    <td><?php echo $course->trainer() ? $course->trainer()->name() : '' ?></td>
